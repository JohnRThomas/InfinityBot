...
public class AES {
    ...
    public static HashMap<String, byte[]> decryptPack(String variable1, String variable2,InputStream innerPackStream) {
        int dummy = 0;
        ...
        try {
            ...
            int bytesread;
            try {
                int bytesRead = innerPackStream.read(buffer, offset, 5242880 - offset);

                while (-1 != bytesRead) {
                    offset += bytesRead;
                    bytesRead = innerPackStream.read(buffer, offset, -offset + 5242880);
                    bytesread = dummy;
